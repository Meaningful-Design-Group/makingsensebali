...
| — | Carcasa impresa en 3D (PETG, no PLA) | Fab Lab Bali | El PLA se ablanda con las temperaturas de las azoteas de Bali. El PETG aguanta. Cinco piezas de encaje a presión, STL y guía de impresión: [`enclosure/node-v3.2/`](enclosure/node-v3.2/). |
...
**Etapa 3 — Carcasa, desplegado.** Imprime en 3D la carcasa de PETG de [`enclosure/node-v3.2/`](enclosure/node-v3.2/) — el Node V3.2 de Fab Lab Bali. Cinco piezas impresas, **sin tornillos**: una tapa superior con encaje a presión con retén, ganchos en voladizo que sujetan cada pieza interna, y agujeros para tornillos de pared más ranuras para amarres plásticos moldeados directamente en la parte trasera del cuerpo, así que no hay soporte aparte que imprimir. Dos variantes de cuerpo, uno o dos puertos de antena, según si usas LoRa. Imprime las tapas que correspondan a tus placas — la tapa del BME680 difiere entre el breakout de Bosch y el módulo Seeed Grove, y la tapa del HM3301 sostiene la mainboard, por lo que la separación de sus ganchos difiere entre el Grove Shield y la PCB DIY. La BoM, el cableado para las tres opciones de mainboard y la secuencia de montaje están en esa carpeta. Los diseños anteriores están en [`enclosure/previous-iterations/`](enclosure/previous-iterations/), conservados por sus notas de fallo, no para construirlos. Móntala a la sombra, nunca bajo sol directo. Aliméntala con una fuente USB estanca o un panel solar de 5V + convertidor reductor (esto último es un proyecto aparte; empieza con alimentación de pared).

> **Lee la advertencia de flujo de aire antes de confiar en los números.** El cuerpo V3 corrige la reaspiración del escape, pero mantiene la admisión en la cara inferior y deja el BME680 en el mismo volumen sellado que la radio — las dos cosas que la co-ubicación del Node V2 señaló como fallas. Hasta que un V3.2 haya funcionado una semana junto a una estación de referencia, trata su temperatura y humedad como no verificadas y espera que los picos de PM se lean bajos. [`enclosure/README.md`](enclosure/README.md) tiene el panorama completo.
