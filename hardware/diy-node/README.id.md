...
| — | Wadah cetak 3D (PETG, bukan PLA) | Fab Lab Bali | PLA melunak pada suhu atap Bali. PETG bertahan. Lima bagian snap-fit, STL, dan panduan cetak: [`enclosure/node-v3.2/`](enclosure/node-v3.2/). |
...
**Tahap 3 — Wadah, dipasang.** Cetak 3D wadah PETG dari [`enclosure/node-v3.2/`](enclosure/node-v3.2/) — Node V3.2 milik Fab Lab Bali. Lima bagian cetak, **tanpa sekrup**: penutup atas dengan *detent snap-fit*, kait *cantilever* yang menahan setiap bagian internal, serta lubang sekrup dinding dan slot *cable tie* yang langsung dicetak pada bagian belakang bodi, sehingga tidak ada braket terpisah yang perlu dicetak. Dua varian bodi, satu atau dua lubang antena, tergantung apakah Anda memakai LoRa. Cetak penutup yang sesuai dengan papan Anda — penutup BME680 berbeda antara breakout Bosch dan modul Seeed Grove, dan penutup HM3301 menahan mainboard sehingga jarak kaitnya berbeda antara Grove Shield dan PCB DIY. BoM, pengkabelan untuk ketiga pilihan mainboard, dan urutan perakitan ada di folder tersebut. Desain-desain sebelumnya ada di [`enclosure/previous-iterations/`](enclosure/previous-iterations/), disimpan untuk catatan kegagalannya, bukan untuk dibangun. Pasang di tempat teduh, jangan pernah di bawah sinar matahari langsung. Beri daya melalui catu daya USB tahan cuaca atau panel surya 5V + konverter buck (yang terakhir adalah proyek terpisah; mulailah dengan daya dinding).

> **Baca peringatan aliran udara sebelum mempercayai angkanya.** Bodi V3 memperbaiki hisap balik udara buang, tetapi tetap mempertahankan lubang masukan di bawah bodi dan membiarkan BME680 berada dalam satu ruang tertutup yang sama dengan radio — dua hal yang justru dipersalahkan oleh ko-lokasi Node V2. Sampai satu unit V3.2 berjalan seminggu berdampingan dengan stasiun acuan, perlakukan suhu dan kelembapannya sebagai belum terverifikasi dan perkirakan puncak PM terbaca rendah. [`enclosure/README.md`](enclosure/README.md) memuat gambaran lengkapnya.
...
[`enclosure/node-v2/`](enclosure/node-v2/) mendokumentasikan node generasi kedua milik Fab Lab Bali sendiri — elektronik XIAO + HM3301 + BME680 yang sama, diletakkan sejajar di satu lantai sasis di dalam cangkang segitiga yang ringkas. Node itu dibangun, dipasang, dan diuji berdampingan dengan SCK, lalu gagal pada dua hal: radio ESP32 memanaskan BME680 lewat dinding sekat, dan lubang masuk udara di bagian bawah terlambat menangkap puncak PM yang nyata. Kedua mode kegagalan itu ditulis lengkap di sana, beserta apa yang harus dilakukan V3 terhadapnya. Baca dulu sebelum Anda merancang cangkang sendiri — itu cara termurah untuk tidak mengulang dua kesalahan tersebut. "V2" di sana menghitung generasi node dan tidak ada hubungannya dengan `enclosure/previous-iterations/archive/v2-lantern/`.
