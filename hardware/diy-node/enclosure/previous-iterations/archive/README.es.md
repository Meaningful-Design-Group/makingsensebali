...
**No forma parte de este linaje:** [`../../node-v2/`](../../node-v2/) es el "Nodo V2" de Fab Lab Bali, con numeración propia — una carcasa triangular compacta para la misma electrónica, documentada con su propia evaluación de campo. Ese número cuenta generaciones de nodo, no los diseños de carcasa de arriba, así que `v2-lantern` y `node-v2` son diseños sin relación que comparten un dígito por casualidad. La advertencia de revisar-antes-de-imprimir también aplica allí, por sus propios motivos.
