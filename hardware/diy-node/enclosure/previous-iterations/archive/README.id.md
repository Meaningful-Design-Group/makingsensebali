...
**Bukan bagian dari garis keturunan ini:** [`../../node-v2/`](../../node-v2/) adalah "Node V2" milik Fab Lab Bali dengan penomorannya sendiri — cangkang segitiga ringkas untuk elektronik yang sama, didokumentasikan lengkap dengan evaluasi lapangannya. Angka itu menghitung generasi node, bukan rancangan enclosure di atas, jadi `v2-lantern` dan `node-v2` adalah dua rancangan yang tidak berhubungan dan kebetulan berbagi satu angka. Penafian tinjau-sebelum-mencetak berlaku di sana juga, dengan alasannya sendiri.
